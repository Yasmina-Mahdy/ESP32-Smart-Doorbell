...
static void task_process_handler(void *arg)
{
    ...
    // Skip corrupted frames
                //ESP_LOGI(TAG, "Got frame: %dx%d len=%d", frame->width, frame->height, frame->len);
                ...
                //ESP_LOGI(TAG, "Stage 1 candidates: %d", (int)detect_candidates.size());
                //ESP_LOGI(TAG, "Stage 2 results: %d", (int)detect_results.size());
